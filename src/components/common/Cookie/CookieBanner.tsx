    ...
    show ? (
      ...
      >
        ...
        <p className="text-sm leading-relaxed text-foreground/70">
          ...
          improve what we ship next. Accept everything, reject the
          non-essential, or pick category by category. See our{" "}
          <PrivacyPolicyLink className="underline underline-offset-2 hover:text-foreground/70">
            privacy policy
          </PrivacyPolicyLink>
          .
        </p>
