      ...
      >
        ...
        >
          ...
          <p className="text-sm leading-relaxed text-foreground/60">
            Choose which categories of cookies we&apos;re allowed to use. You
            can change this any time. See our{" "}
            <PrivacyPolicyLink className="text-foreground underline underline-offset-2">
              privacy policy
            </PrivacyPolicyLink>
            .
          </p>
